    ...
    Tables: {
      ...
      equipment: {
        Row: {
          ...
          aspen_equipment_id: string | null;
          aspen_customer_id: string | null;
        };
        Insert: {
          id?: string;
          business_account_id: string;
      ...
      aspen_equipment_imports: {
        Row: {
          id: string;
          aspen_customer_id: string;
          aspen_equipment_id: string;
          make: string;
          model: string;
          model_year: number | null;
          serial_number: string | null;
          ...
          purchase_dealership_location_id: string | null;
          current_hours: number | null;
          promoted_equipment_id: string | null;
        ...
        Update: Partial<Database["public"]["Tables"]["aspen_equipment_imports"]["Insert"]>;
        Relationships: [];
      };
      aspen_invoices: {
        Row: {
      ...
      aspen_service_history: {
        ...
        Update: Partial<Database["public"]["Tables"]["aspen_service_history"]["Insert"]>;
        Relationships: [];
      };
    };
...
export type AspenEquipmentImport = Database["public"]["Tables"]["aspen_equipment_imports"]["Row"];
export type AspenInvoice = Database["public"]["Tables"]["aspen_invoices"]["Row"];
export type AspenServiceHistory = Database["public"]["Tables"]["aspen_service_history"]["Row"];
